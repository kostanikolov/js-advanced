...
let obj = softunify.downloadSong('Eminem', 'Not Afraid', 'I\'m not afraid to take a stand...');
console.log(obj);
// softunify.downloadSong('Eminem', 'Venom', 'Knock, Knock let the devil in...');
// console.log(softunify.downloadSong('Eminem', 'Phenomenal', 'IM PHENOMENAL...'));

// console.log(softunify.downloadSong('Lamb of God', 'Descending', 'Deeeesceeeendiiiiing...'));

// console.log(softunify.allSongs['Eminem'].songs);
